...
final readonly class ThemeSettingsReader {
  ...
  public function __construct(
    ...
    private ?ThemeSettingsProvider $themeSettingsProvider = NULL,
  ) {}
  ...
  private function allSettings(string $theme): mixed {
    if ($this->themeSettingsProvider instanceof ThemeSettingsProvider) {
      return $this->themeSettingsProvider->getSetting('', $theme);
    }
